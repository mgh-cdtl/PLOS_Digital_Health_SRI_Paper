...
sys.path.append('Directory path the input file is in')
...
class Patient:
    def __init__(self, hospitalaccountid, encounterid, esrd, complaint_dms, fatigue_or_ams, majorcomorbidity, pre_ed_infection, bacterialsymptomcomplex, cad_, chf_, ckd_, copd_, cva_, diabetes_, liver_, pneumonia_, uti_, abdominal_, skin_, other_, unknown_):
        ...
        self.continuous_processed_only_vital_list = []
        self.processed_one_hr_full_model_score = None
        self.processed_two_hr_full_model_score = None
        self.processed_three_hr_full_model_score = None
        self.processed_four_hr_full_model_score = None
        self.processed_five_hr_full_model_score = None
        self.processed_six_hr_full_model_score = None
        ...
        self.two_hr_full_model_score = None
        self.two_hr_vs_model_score = None
        self.two_hr_qsofa_score = None

        self.four_hr_full_model_score = None
        self.four_hr_vs_model_score = None
        self.four_hr_qsofa_score = None

        self.five_hr_full_model_score = None
        self.five_hr_vs_model_score = None
        self.five_hr_qsofa_score = None

        self.six_hr_full_model_score = None
        self.six_hr_vs_model_score = None
        self.six_hr_qsofa_score = None
...
#debug
        ...
        for time in self.timelist:
            ...
            if gcs_min is None:
                if complaint_dms == 0:  # assigns gcs = 15 if altered mental status label is false on redcap
                    self.gcss.add_gcs_measurement(Patient.GenericVital(float(15), self.ed_in))
                    gcs_min = Patient.GenericVital(float(15), self.ed_in)
                elif complaint_dms == 1:
                    self.gcss.add_gcs_measurement(Patient.GenericVital(float(14), self.ed_in))
                    gcs_min = Patient.GenericVital(float(14), self.ed_in)

#cha- accessing actual values
            sbp_exp_processed = self.sbps.get_most_recent_exp_vital_given_time(time)
            si_exp_processed = self.shock_indexes.get_most_recent_exp_vital_given_time(time)
            temp_processed = self.temps.get_most_recent_vital_given_time(time)
            temp_low_processed = self.temps.get_min_vital_up_until_time(time)
            temp_high_processed = self.temps.get_max_vital_up_until_time(time)
            resp_exp_processed = self.resps.get_most_recent_expresp_given_time(time)
            spo2_exp_processed = self.spo2s.get_most_recent_exp_vital_given_time(time)
            gcs_min_processed = self.gcss.get_min_vital_up_until_time(time)
            if gcs_min_processed is None:
                if complaint_dms == 0:  # assigns gcs = 15 if altered mental status label is false on redcap
                    self.gcss.add_gcs_measurement(Patient.GenericVital(float(15), self.ed_in))
                    gcs_min_processed = Patient.GenericVital(float(15), self.ed_in)
                elif complaint_dms == 1:
                    self.gcss.add_gcs_measurement(Patient.GenericVital(float(14), self.ed_in))
                    gcs_min_processed = Patient.GenericVital(float(14), self.ed_in)

#end of actual vitals
            ...
            self.continuous_processed_only_vital_list.append(
            Patient.ContinuousProcessedOnly(time, sbp_exp_processed, si_exp_processed, resp_exp_processed, spo2_exp_processed, temp_processed, gcs_min_processed))

            if sbp_exp_clipped is not None and si_exp_clipped is not None and temp_low_clipped is not None and \
                    temp_high_clipped is not None and resp_exp_clipped is not None and spo2_exp_clipped is not None \
                    and \
                    gcs_min is not None:
...
#cha defining functions for SRI computation for 2 hrs
    def set_2hr_full_model_score(self, score):
        self.two_hr_full_model_score = score
    def get_2hr_full_model_score(self):
        return self.two_hr_full_model_score
    def set_2hr_vs_model_score(self, score):
        self.two_hr_vs_model_score = score
    def get_2hr_vs_model_score(self):
        return self.two_hr_vs_model_score
    def set_2hr_qsofa_score(self, score):
        self.two_hr_qsofa_score = score
    def get_2hr_qsofa_score(self):
        return self.two_hr_qsofa_score

    def set_4hr_full_model_score(self, score):
        self.four_hr_full_model_score = score
    def get_4hr_full_model_score(self):
        return self.four_hr_full_model_score
    def set_4hr_vs_model_score(self, score):
        self.four_hr_vs_model_score = score
    def get_4hr_vs_model_score(self):
        return self.four_hr_vs_model_score
    def set_4hr_qsofa_score(self, score):
        self.four_hr_qsofa_score = score
    def get_4hr_qsofa_score(self):
        return self.four_hr_qsofa_score

    def set_5hr_full_model_score(self, score):
        self.five_hr_full_model_score = score
    def get_5hr_full_model_score(self):
        return self.five_hr_full_model_score
    def set_5hr_vs_model_score(self, score):
        self.five_hr_vs_model_score = score
    def get_5hr_vs_model_score(self):
        return self.five_hr_vs_model_score
    def set_5hr_qsofa_score(self, score):
        self.five_hr_qsofa_score = score
    def get_5hr_qsofa_score(self):
        return self.five_hr_qsofa_score

    def set_6hr_full_model_score(self, score):
        self.six_hr_full_model_score = score
    def get_6hr_full_model_score(self):
        return self.six_hr_full_model_score
    def set_6hr_vs_model_score(self, score):
        self.six_hr_vs_model_score = score
    def get_6hr_vs_model_score(self):
        return self.six_hr_vs_model_score
    def set_6hr_qsofa_score(self, score):
        self.six_hr_qsofa_score = score
    def get_6hr_qsofa_score(self):
        return self.six_hr_qsofa_score


    def set_processed_1hr_full_model_score(self, score):
        self.processed_one_hr_full_model_score = score
    def get_processed_1hr_full_model_score(self):
        return self.processed_one_hr_full_model_score
    def set_processed_2hr_full_model_score(self, score):
        self.processed_two_hr_full_model_score = score
    def get_processed_2hr_full_model_score(self):
        return self.processed_two_hr_full_model_score
    def set_processed_3hr_full_model_score(self, score):
        self.processed_three_hr_full_model_score = score
    def get_processed_3hr_full_model_score(self):
        return self.processed_three_hr_full_model_score
    def set_processed_4hr_full_model_score(self, score):
        self.processed_four_hr_full_model_score = score
    def get_processed_4hr_full_model_score(self):
        return self.processed_four_hr_full_model_score
    def set_processed_5hr_full_model_score(self, score):
        self.processed_five_hr_full_model_score = score
    def get_processed_5hr_full_model_score(self):
        return self.processed_five_hr_full_model_score
    def set_processed_6hr_full_model_score(self, score):
        self.processed_six_hr_full_model_score = score
    def get_processed_6hr_full_model_score(self):
        return self.processed_six_hr_full_model_score
    ...
    class ContinuousProcessedOnly:
        def __init__(self, time, sbp_exp_processed, si_exp_processed, resp_exp_processed, spo2_exp_processed, temp_exp_processed, gcs_exp_processed):
            self.time = time
            self.sbp_exp_processed = sbp_exp_processed
            self.si_exp_processed = si_exp_processed
            self.resp_exp_processed = resp_exp_processed
            self.spo2_exp_processed = spo2_exp_processed
            self.temp_exp_processed = temp_exp_processed
            self.gcs_exp_processed = gcs_exp_processed

        def get_time(self):
            return self.time
        def get_sbp_exp_processed(self):
            return self.sbp_exp_processed
        def get_si_exp_processed(self):
            return self.si_exp_processed
        def get_resp_exp_processed(self):
            return self.resp_exp_processed
        def get_spo2_exp_processed(self):
            return self.spo2_exp_processed
        def get_temp_exp_processed(self):
            return self.temp_exp_processed
        def get_gcs_exp_processed(self):
            return self.gcs_exp_processed
#This sepsis list was created with Rhee_Validation_usingREDcap.py and Rhee_Validation_usingREDcap_analysis.py
#Based on modified Rheet et. Al., criteria:
#
# Presumed serious infection:
# -Blood cultures obtained (for spot2, there’s a redcap field for Bcx until 24 hours after ED-dispo, for spot3 I’ll do a query for bcx until 24 hours after ED-dispo) AND
# -4 QADs (for spot2 there’s an adjudicated redcap field, for spot3, there's a function FourQAD.py)
#
# AND Acute organ dysfunction (any 1 of the following within 48 hours of ED arrival time)
# -Vasopressors (For spot2 there’s a redcap field for vasos within 48 hrs of ED arrival, for spot3 I have a query)
# -Mechanical ventilation (For spot2 there’s a redcap field for “Any Positive Pressure Ventilation in 48 Hours”, for spot3 I have a query for “CPAP” “BiPAP” or “ventilator” as the O2_delivery within vitals)
# -Doubling of Cr or 50% decrease in GFR from baseline, excluding end-stage renal disease (we’ll use the best value throughout the hospitalization as the “baseline”, if only 1 measurement is taken throughout the hospitalization it’ll be discarded. Varesh will do a query for spot2, and I already have a query for spot3, which is not manually validated. Values that are within 48 hours of ED arrival will be used to meet the criteria, although values from the entire hospitalization will be used to determine “baseline”. Patients who are “Dialysis dependent” on REDCAP will be excluded)
# -Tbili >=2 and doubling from baseline (same as Creatinine/GFR)
# -Platelet <100 and 50% decline from baseline, baseline must be at least 100 (same as Creatinine/GFR)
# -Lactate >= 2.0 (value from 48 hours of ED arrival)
#
...
for patient in patientlist:
    fullmodel_modelscorelist.append(''' Redacted code''')
full_modelscore_average = sum(fullmodel_modelscorelist) / len(fullmodel_modelscorelist)
print("fullmodel_modelscorelist",fullmodel_modelscorelist)
print("full_model_constant", full_model_constant)
...
print("final full_model_constant before calculating fullscore.",full_model_constant )
for patient in patientlist:
...
columns = ["hospitalaccountid","patientencounterid", "spo2", "gcs", "predictorsbp", "age", "male_sex", "predictortemp",
...
for patient in patientlist:
    writer.writerow({"hospitalaccountid": patient.get_hospital_account_id(),
                     "patientencounterid": patient.get_patient_encounter_id(),
...
six_hrs_sepsis_qsofa_scores = []
six_hrs_nosepsis_qsofa_scores = []
five_hrs_sepsis_full_scores = []
five_hrs_nosepsis_full_scores = []
five_hrs_sepsis_vs_scores = []
five_hrs_nosepsis_vs_scores = []
five_hrs_sepsis_qsofa_scores = []
five_hrs_nosepsis_qsofa_scores = []

#lists to hold highest SRIs of all the patients starting from triage to 1 hr, triage to 2 hr, triage to 3hr, triage to 4 hr, triage to 5hr, triage to 6hr
highest_SRI_from_triage_to_1hr=[]
highest_SRI_from_triage_to_2hr=[]
highest_SRI_from_triage_to_3hr=[]
highest_SRI_from_triage_to_4hr=[]
highest_SRI_from_triage_to_5hr=[]
highest_SRI_from_triage_to_6hr=[]
...
for patient in patientlist:
    ...
    processed_fullscorefirstflag = False
    ...
    three_hrs_qsofa_score = None

    five_hrs_full_score = None
    five_hrs_vs_score = None
    five_hrs_qsofa_score = None

    six_hrs_full_score = None
    six_hrs_vs_score = None
    six_hrs_qsofa_score = None

    processed_one_hr_full_score = None
    processed_two_hrs_full_score = None
    processed_three_hrs_full_score = None
    processed_four_hrs_full_score = None
    processed_five_hrs_full_score = None
    processed_six_hrs_full_score = None
    SRIs_within_1hr = []
    SRIs_within_2hr = []
    SRIs_within_3hr = []
    SRIs_within_4hr = []
    ...
    for processedvitalset in patient.get_processed_vital_list():
        ...
        if time_difference < 3600:
            SRIs_within_1hr.append(full_score)
        if time_difference < 7200:
            SRIs_within_2hr.append(full_score)
        if time_difference < 10800:
            SRIs_within_3hr.append(full_score)
        if time_difference < 14400:
            SRIs_within_4hr.append(full_score)
        if time_difference < 18000:
            SRIs_within_5hr.append(full_score)
        if time_difference < 21600:
            SRIs_within_6hr.append(full_score)
    ...
    for processedvitalset in patient.get_processed_vital_list():
        ...
        if 10800 <= time_difference < 14400:
            four_hr_full_score = fullscore_max
            four_hrs_vs_score = vsscore_max
            four_hrs_qsofa_score = qsofa_max

        if 14400 <= time_difference < 18000:
            five_hr_full_score = fullscore_max
            five_hrs_vs_score = vsscore_max
            five_hrs_qsofa_score = qsofa_max
        ...
        if 18000 <= time_difference < 21600:
            ...
            six_hrs_qsofa_score = qsofa_max


    if SRIs_within_1hr and (max(SRIs_within_1hr) > patient.get_full_model_score()):
        patient.set_processed_1hr_full_model_score(max(SRIs_within_1hr))
        highest_SRI_from_triage_to_1hr.append(max(SRIs_within_1hr))
    else:
        patient.set_processed_1hr_full_model_score(patient.get_full_model_score())
        highest_SRI_from_triage_to_1hr.append(patient.get_full_model_score())

    if SRIs_within_2hr and (max(SRIs_within_2hr) > patient.get_full_model_score()):
        patient.set_processed_2hr_full_model_score(max(SRIs_within_2hr))
        highest_SRI_from_triage_to_2hr.append(max(SRIs_within_2hr))
    else:
        patient.set_processed_2hr_full_model_score(patient.get_full_model_score())
        highest_SRI_from_triage_to_2hr.append(patient.get_full_model_score())

    if SRIs_within_3hr and (max(SRIs_within_3hr) > patient.get_full_model_score()):
        patient.set_processed_3hr_full_model_score(max(SRIs_within_3hr))
        highest_SRI_from_triage_to_3hr.append(max(SRIs_within_3hr))
    else:
        patient.set_processed_3hr_full_model_score(patient.get_full_model_score())
        highest_SRI_from_triage_to_3hr.append(patient.get_full_model_score())

    if SRIs_within_4hr and (max(SRIs_within_4hr) > patient.get_full_model_score()):
        patient.set_processed_4hr_full_model_score(max(SRIs_within_4hr))
        highest_SRI_from_triage_to_4hr.append(max(SRIs_within_4hr))
    else:
        patient.set_processed_4hr_full_model_score(patient.get_full_model_score())
        highest_SRI_from_triage_to_4hr.append(patient.get_full_model_score())

    if SRIs_within_5hr and (max(SRIs_within_5hr) > patient.get_full_model_score()):
        patient.set_processed_5hr_full_model_score(max(SRIs_within_5hr))
        highest_SRI_from_triage_to_5hr.append(max(SRIs_within_5hr))
    else:
        patient.set_processed_5hr_full_model_score(patient.get_full_model_score())
        highest_SRI_from_triage_to_5hr.append(patient.get_full_model_score())

    if SRIs_within_6hr and (max(SRIs_within_6hr) > patient.get_full_model_score()):
        patient.set_processed_6hr_full_model_score(max(SRIs_within_6hr))
        highest_SRI_from_triage_to_6hr.append(max(SRIs_within_6hr))
    else:
        patient.set_processed_6hr_full_model_score(patient.get_full_model_score())
        highest_SRI_from_triage_to_6hr.append(patient.get_full_model_score())
    ...
    if six_hrs_full_score is not None:
        patient.set_6hr_full_model_score(six_hrs_full_score)
        patient.set_6hr_vs_model_score(six_hrs_vs_score)
        patient.set_6hr_qsofa_score(six_hrs_qsofa_score)
        if patient.get_rhee_sepsis() == 1:
            six_hrs_sepsis_full_scores.append(six_hrs_full_score)
            six_hrs_sepsis_vs_scores.append(six_hrs_vs_score)
            six_hrs_sepsis_qsofa_scores.append(six_hrs_qsofa_score)
        elif patient.get_rhee_sepsis() == 0:
            six_hrs_nosepsis_full_scores.append(six_hrs_full_score)
            six_hrs_nosepsis_vs_scores.append(six_hrs_vs_score)
            six_hrs_nosepsis_qsofa_scores.append(six_hrs_qsofa_score)
...
#cha
    ...
    if five_hrs_full_score is not None:
        patient.set_5hr_full_model_score(five_hrs_full_score)
        patient.set_5hr_vs_model_score(five_hrs_vs_score)
        patient.set_5hr_qsofa_score(five_hrs_qsofa_score)
        if patient.get_rhee_sepsis() == 1:
            five_hrs_sepsis_full_scores.append(five_hrs_full_score)
            five_hrs_sepsis_vs_scores.append(five_hrs_vs_score)
            five_hrs_sepsis_qsofa_scores.append(five_hrs_qsofa_score)
        elif patient.get_rhee_sepsis() == 0:
            five_hrs_nosepsis_full_scores.append(five_hrs_full_score)
            five_hrs_nosepsis_vs_scores.append(five_hrs_vs_score)
            five_hrs_nosepsis_qsofa_scores.append(five_hrs_qsofa_score)
    ...
    columns = ["hospitalaccountid","patientencounterid", "antibioticHr", "sepsis", "full_score_triage", "1hrfullscore", "2hrfullscore","3hrfullscore",
               "4hrfullscore","5hrfullscore","6hrfullscore","vs_score_triage","1hrvsscore","2hrvsscore","3hrvsscore","4hrvsscore","5hrvsscore","6hrvsscore",
               "qsofa_triage","1hrqsofascore","2hrqsofascore","3hrqsofascore","4hrqsofascore","5hrqsofascore","6hrqsofascore"]
    out_file = open(
  ...
  #  Gcss(self.hospitalaccountid, False).get_ed_triage_vital()
    for patient in patientlist:
        writer.writerow({
            ...
            "1hrfullscore": patient.get_1hr_full_model_score(),
            "2hrfullscore": patient.get_2hr_full_model_score(),
            "3hrfullscore": patient.get_3hr_full_model_score(),
            "4hrfullscore": patient.get_4hr_full_model_score(),
            "5hrfullscore": patient.get_5hr_full_model_score(),
            "6hrfullscore": patient.get_6hr_full_model_score(),
            "vs_score_triage": patient.get_vs_model_score(),
            "1hrvsscore": patient.get_1hr_vs_model_score(),
            "2hrvsscore": patient.get_2hr_vs_model_score(),
            "3hrvsscore": patient.get_3hr_vs_model_score(),
            "4hrvsscore": patient.get_4hr_vs_model_score(),
            "5hrvsscore": patient.get_5hr_vs_model_score(),
            "6hrvsscore": patient.get_6hr_vs_model_score(),
            "qsofa_triage": patient.get_qsofa(),
            "1hrqsofascore": patient.get_1hr_qsofa_score(),
            "2hrqsofascore": patient.get_2hr_qsofa_score(),
            "3hrqsofascore": patient.get_3hr_qsofa_score(),
            "4hrqsofascore": patient.get_4hr_qsofa_score(),
            "5hrqsofascore": patient.get_5hr_qsofa_score(),
            "6hrqsofascore": patient.get_6hr_qsofa_score()
                 })

    columns = ["hospitalaccountid","patientencounterid", "sepsis", "full_score_triage", "1hrfullscore", "2hrfullscore","3hrfullscore",
               "4hrfullscore","5hrfullscore","6hrfullscore"]
    out_file = open(
        "cha_maxSRI_hourly_basis.csv", "w")
    writer = csv.DictWriter(out_file, fieldnames=columns)
    writer.writeheader()
    for patient in patientlist:
        writer.writerow({
             ...
             "sepsis": patient.get_rhee_sepsis(),
             "full_score_triage": patient.get_full_model_score(),
             "1hrfullscore": patient.get_processed_1hr_full_model_score(),
             "2hrfullscore": patient.get_processed_2hr_full_model_score(),
             "3hrfullscore": patient.get_processed_3hr_full_model_score(),
             "4hrfullscore": patient.get_processed_4hr_full_model_score(),
             "5hrfullscore": patient.get_processed_5hr_full_model_score(),
             "6hrfullscore": patient.get_processed_6hr_full_model_score(),
             })
...
print("Highest SRI from triage to 1 hour: ", highest_SRI_from_triage_to_1hr)
print("Highest SRI from triage to 2 hour: ", highest_SRI_from_triage_to_2hr)
print("Highest SRI from triage to 3 hour: ", highest_SRI_from_triage_to_3hr)
print("Highest SRI from triage to 4 hour: ", highest_SRI_from_triage_to_4hr)
print("Highest SRI from triage to 5 hour: ", highest_SRI_from_triage_to_5hr)
print("Highest SRI from triage to 6 hour: ", highest_SRI_from_triage_to_6hr)
...
sepsis_abx_less_than_3_hr_of_hypotension_count = 0
nosepsis_abx_less_than_3_hr_of_hypotension_count = 0
        ...
        if vitalset.get_sbp_cont() is not None:
            if vitalset.get_sbp_cont().get_value() < 90 and not first_hypotension_flag:
                ...
                if isinstance(patient.get_first_antibiotic_time(), datetime.datetime):
                    ...
                    if abx_hypotention_time_diff_ < 10800:
                        if sepsis_ == 1:
...
demographics.append(['abx_less_than_3_hr_of_hypotension', sepsis_abx_less_than_3_hr_of_hypotension_count/total_rhee_count, nosepsis_abx_less_than_3_hr_of_hypotension_count/nonseptic_count,sepsis_abx_less_than_3_hr_of_hypotension_count,nosepsis_abx_less_than_3_hr_of_hypotension_count])
...
raw_temp_list= []
raw_si_list= []
patientencounterid_list = []



# raw vitals as it is without processing
columns = ["patientencounterid","time", "raw_sbp","raw_spo2","raw_resp","raw_temp","raw_si","raw_gcs"]
out_file = open(
        "cha_raw_vitals_through_time.csv", "w")
writer = csv.DictWriter(out_file, fieldnames=columns)
writer.writeheader()
for patient in patientlist:

    for i in patient.continuous_unprocessed_vital_list:
            # sbptest = i.sbp_cont
            # timetest= i.time.strftime('%d,-%b- %Y %H:%M')
            raw_vital_timelist.append(i.time.strftime('%d,-%b- %Y %H:%M'))
            raw_sbp_list.append(i.sbp_cont)
            raw_spo2_list.append(i.spo2_cont)
            raw_resp_list.append(i.resp_cont)
            raw_gcs_list.append(i.gcs_cont)
            raw_temp_list.append(i.temp_cont)
            raw_si_list.append(i.si_cont)
            patientencounterid_list.append(patient.get_patient_encounter_id())
            writer.writerow({
                    "patientencounterid": patient.get_patient_encounter_id(),
                     "time": i.time.strftime('%d,-%b- %Y %H:%M'),
                     "raw_sbp": i.sbp_cont.get_value() if i.sbp_cont is not None else "None",
                    "raw_spo2": i.spo2_cont.get_value() if i.spo2_cont is not None else "None",
                    "raw_resp": i.resp_cont.get_value() if i.resp_cont is not None else "None",
                    "raw_temp": i.temp_cont.get_value() if i.temp_cont is not None else "None",
                    "raw_si": i.si_cont.get_value() if i.si_cont is not None else "None",
                    "raw_gcs": i.gcs_cont.get_value() if i.gcs_cont is not None else "None"
                   })
# SRI for everytime new vitals measured
columns = ["patientencounterid","time", "processed_and_clipped_sbp", "processed_and_clipped_spo2","processed_and_clipped_resp",
        "processed_and_clipped_temp","processed_and_clipped_temp","processed_and_clipped_si", "processed_and_clipped_gcs","SRI"]
out_file = open(
    "cha_SRI_through_time.csv", "w")
writer = csv.DictWriter(out_file, fieldnames=columns)
writer.writeheader()
for patient in patientlist:
    ...
    for processedvitalset in patient.get_processed_vital_list():
        ...
        spo2_exp = processedvitalset.get_spo2_exp_cont()
        gcs_min = processedvitalset.get_gcs_min_cont()
        time_new_vital_measured = processedvitalset.get_time().strftime('%d,-%b- %Y %H:%M')

        full_score = ''' Redacted code '''

        writer.writerow({
        "patientencounterid": patient.get_patient_encounter_id(),
        "time": time_new_vital_measured,
        "processed_and_clipped_sbp": sbp_exp,
        "processed_and_clipped_spo2": spo2_exp,
        "processed_and_clipped_resp": resp_exp,
        "processed_and_clipped_temp": temp_low,
        "processed_and_clipped_temp": temp_high,
        "processed_and_clipped_si": si_exp,
        "processed_and_clipped_gcs": gcs_min,
        "SRI": full_score
    })
...
# vitals processed
processedonly_vital_timelist = []
processedonly_sbp_list = []
processedonly_spo2_list= []
processedonly_resp_list= []
processedonly_gcs_list= []
processedonly_temp_list= []
processedonly_si_list= []
processedonly_patientencounterid_list = []
columns = ["patientencounterid","time", "latest_sbp","latest_spo2","latest_resp","latest_temp","latest_si","latest_gcs"]
out_file = open(
        "cha_processed_only_vitals_through_time.csv", "w")
writer = csv.DictWriter(out_file, fieldnames=columns)
writer.writeheader()
for patient in patientlist:

    for i in patient.continuous_processed_only_vital_list:
            # sbptest = i.sbp_cont
            # timetest= i.time.strftime('%d,-%b- %Y %H:%M')
            processedonly_vital_timelist.append(i.time.strftime('%d,-%b- %Y %H:%M'))
            processedonly_sbp_list.append(i.sbp_exp_processed)
            processedonly_spo2_list.append(i.spo2_exp_processed)
            processedonly_resp_list.append(i.resp_exp_processed)
            processedonly_gcs_list.append(i.gcs_exp_processed)
            processedonly_temp_list.append(i.temp_exp_processed)
            processedonly_si_list.append(i.si_exp_processed)
            processedonly_patientencounterid_list.append(patient.get_patient_encounter_id())
            writer.writerow({
                    "patientencounterid": patient.get_patient_encounter_id(),
                     "time": i.time.strftime('%d,-%b- %Y %H:%M'),
                     "latest_sbp": i.sbp_exp_processed.get_value() if i.sbp_exp_processed is not None else "None",
                    "latest_spo2": i.spo2_exp_processed.get_value() if i.spo2_exp_processed is not None else "None",
                    "latest_resp": i.resp_exp_processed.get_value() if i.resp_exp_processed is not None else "None",
                    "latest_temp": i.temp_exp_processed.get_value() if i.temp_exp_processed is not None else "None",
                    "latest_si": i.si_exp_processed.get_value() if i.si_exp_processed is not None else "None",
                    "latest_gcs": i.gcs_exp_processed.get_value() if i.gcs_exp_processed is not None else "None"
                   })

#finding rocauc's for highest SRI on hourly basis starting from triage
...
fullmodel_auc_triage_to_1hr = roc_auc_score(labellist, highest_SRI_from_triage_to_1hr)

fullmodel_auc_triage_to_2hr = roc_auc_score(labellist, highest_SRI_from_triage_to_2hr)

fullmodel_auc_triage_to_3hr = roc_auc_score(labellist, highest_SRI_from_triage_to_3hr)
fullmodel_auc_triage_to_4hr = roc_auc_score(labellist, highest_SRI_from_triage_to_4hr)
fullmodel_auc_triage_to_5hr = roc_auc_score(labellist, highest_SRI_from_triage_to_5hr)
fullmodel_auc_triage_to_6hr = roc_auc_score(labellist, highest_SRI_from_triage_to_6hr)
...
print("roc_auc for fullmodel from triage to 1 hour",fullmodel_auc_triage_to_1hr)
print("roc_auc for fullmodel from triage to 2 hour",fullmodel_auc_triage_to_2hr)
print("roc_auc for fullmodel from triage to 3 hour",fullmodel_auc_triage_to_3hr)
print("roc_auc for fullmodel from triage to 4 hour",fullmodel_auc_triage_to_4hr)
print("roc_auc for fullmodel from triage to 5 hour",fullmodel_auc_triage_to_5hr)
print("roc_auc for fullmodel from triage to 6 hour",fullmodel_auc_triage_to_6hr)
